...
class SupabaseConfig {
  ...
  static Future<void> initialize() async {
    ...
    AppLogger.info('Supabase environment variables loaded in ${envLoadDuration.inMilliseconds}ms');
    ...
    final supabaseClientInitDuration = DateTime.now().difference(supabaseClientInitStart);
    AppLogger.info('Supabase client initialized in ${supabaseClientInitDuration.inMilliseconds}ms');

    client = Supabase.instance.client;
    AppLogger.info('Supabase client instance obtained');

    final totalDuration = DateTime.now().difference(supabaseInitStart);
    AppLogger.info('Supabase initialization completed in ${totalDuration.inMilliseconds}ms');
  }
