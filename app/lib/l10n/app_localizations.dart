...
abstract class AppLocalizations {
  ...
  /// No description provided for @errorUpdatingReaction.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @motivationalNotifications.
  ///
  /// In en, this message translates to:
  /// **'Motivational notifications'**
  String get motivationalNotifications;

  /// No description provided for @motivationalNotificationsDesc.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @newMessagesOrLoginRequired.
  ///
  /// In en, this message translates to:
  /// **'New messages or login required'**
  String get newMessagesOrLoginRequired;

  /// No description provided for @activeDiscountsAvailable.
  ///
  /// In en, this message translates to:
  /// **'Active discounts available'**
  String get activeDiscountsAvailable;
  ...
  /// No description provided for @openBQIDSettings.
  ///
  /// In en, this message translates to:
  /// **'Open BQID settings'**
  String get openBQIDSettings;

  /// No description provided for @breakReminderTitle.
  ///
  /// In en, this message translates to:
  /// **'Time for a Break'**
  String get breakReminderTitle;

  /// No description provided for @breakReminderMessage.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @breakReminderOk.
  ///
  /// In en, this message translates to:
  /// **'OK, I\'ll take a break'**
  String get breakReminderOk;

  /// No description provided for @breakReminderContinue.
  ///
  /// In en, this message translates to:
  /// **'Continue'**
  String get breakReminderContinue;
  ...
  /// Prompt to continue with a specific lesson
  ///
  /// In en, this message translates to:
  ...
  /// Error when social media platform cannot be opened
  ///
  /// In en, this message translates to:
  /// **'Could not open {platform}'**
  String couldNotOpenPlatform(String platform);

  /// Label for a lesson with index and title
  ///
  /// In en, this message translates to:
  /// **'Lesson {index}: {title}'**
  String lessonLabel(int index, String title);

  /// Recommended lesson label
  ///
  /// In en, this message translates to:
  /// **'Recommended: {label}'**
  ...
  /// Semantic label for section icon
  ///
  /// In en, this message translates to:
