...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Play against each other on one phone! The phone is split in two - top half rotates 180 degrees.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Customize your theme, game speed, and sound effects in settings. Do you have any questions or suggestions? We would love to hear from you at {email}'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Connect with other BibleQuiz users, share achievements and compete on leaderboards!'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Failed to connect to BQID. Check the ID and try again.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'View app introduction and tutorial'**
  ...
  ///
  /// In en, this message translates to:
  /// **'You got 50 points and got 50 cents donated for renovation of Elim!'**
  ...
  ///
  /// In en, this message translates to:
  /// **'You have been using BibleQuiz for {streakDays} {streakDays, plural, one{day} other{days}} in a row'**
