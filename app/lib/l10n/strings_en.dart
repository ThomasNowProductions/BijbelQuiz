...
class AppStringsEn {
  ...
  // Multiplayer Strings
  static const String onlineMultiplayerQuiz = 'Online Multiplayer Quiz';
  static const String createGame = 'Create Game';
  static const String joinGame = 'Join Game';
  static const String gameCode = 'Game Code';
  static const String enterGameCode = 'Enter the 6-letter code';
  static const String gameCodeRequired = 'Game code must be 6 letters';
  static const String creatingGame = 'Creating game...';
  static const String joiningGame = 'Connecting...';
  ...
  static const String multiplayerGameSettings = 'Game Settings';
  static const String numberOfQuestions = 'Number of questions';
  static const String timeLimit = 'Time limit';
  static const String questionTime = 'Question time';
  static const String seconds = 'seconds';
  static const String multiplayerMinutes = 'minutes';
  static const String gameRules = 'Game Rules';
  static const String multiplayerRule1 = '• Maximum 50 players per game';
  static const String multiplayerRule2 = '• 20 seconds to answer each question';
  static const String multiplayerRule3 = '• Faster answers give bonus points';
  static const String multiplayerRule4 = '• Organizer decides when game starts';
  static const String multiplayerRule5 = '• Organizer advances to next questions';
  static const String waitingForOrganizer = 'Waiting for organizer to start...';
  static const String waitForAllPlayers = 'Waiting for all players to finish...';
  static const String continueToNext = 'Continue to next';
  ...
  static const String gameCodeCopied = 'Game code copied to clipboard';
  static const String shareGameCode = 'Share this code with others to join';
  static const String minimumPlayersRequired = 'Minimum 2 players required to start';
  static const String gameFull = 'Game is full (max 50 players)';
  static const String invalidGameCode = 'Invalid game code';
  static const String gameNotFound = 'Game not found';
  static const String gameAlreadyStarted = 'Game has already started';
  static const String gameFinished = 'Game is finished';
  static const String loginRequiredForMultiplayer = 'Login required for multiplayer';
  static const String loginRequiredForMultiplayerDesc = 'Create an account to participate in multiplayer quizzes. Your username will be used in leaderboards.';
}
