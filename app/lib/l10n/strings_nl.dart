...
class AppStrings {
  ...
  static const String timeUpMessage = 'Je hebt niet op tijd geantwoord. Je reeks is gereset.';
  ...
  static const String hidePopupDesc = 'Wil je deze instelling alleen aanzetten als u aan ons heeft gedoneerd? We hebben geen manier om het te verifieren, maar we vertrouwen erop dat je eerlijk bent.';
  ...
  static const String resetProgressConfirmation = 'Weet je zeker dat je je voortgang wilt resetten? Dit kan niet ongedaan worden gemaakt.';
  ...
  static const String welcomeDescription = 'Ontdek de Bijbel op een leuke en interactieve manier met uitdagende vragen en lessen.';
  static const String howToPlayTitle = 'Hoe speel je?';
  static const String howToPlayDescription = 'Beantwoord vragen over de Bijbel en verdien punten. Hoe sneller je antwoordt, hoe meer punten je verdient!';
  static const String notificationsTitle = 'Blijf op de hoogte';
  static const String notificationsDescription = 'Ontvang herinneringen en uitdagingen om je Bijbelkennis te verbeteren.';
  ...
  static const String activationSubtitle = 'Voer je activatiecode in om de app te gebruiken';
  ...
  static const String activationTip = 'Voer de activatiecode in die je hebt ontvangen bij aankoop.';
  static const String activationSuccess = 'Succesvol geactiveerd!';
  static const String activationError = 'Ongeldige activatiecode. Probeer het opnieuw.';
  static const String activationErrorTitle = 'Activatie mislukt';
  static const String activationSuccessMessage = 'Je account is succesvol geactiveerd. Veel plezier met de app!';
  static const String activationRequired = 'Activatie vereist';
  static const String activationRequiredMessage = 'Je moet de app activeren voordat je deze kunt gebruiken.';
  ...
  static const String doubleStars5QuestionsDesc = 'Verdien dubbele sterren voor je volgende 5 vragen';
  static const String tripleStars5Questions = 'Driedubbele sterren (5 vragen)';
  static const String tripleStars5QuestionsDesc = 'Verdien driedubbele sterren voor je volgende 5 vragen';
  static const String fiveTimesStars5Questions = '5x sterren (5 vragen)';
  static const String fiveTimesStars5QuestionsDesc = 'Verdien 5x sterren voor je volgende 5 vragen';
  static const String doubleStars60Seconds = 'Dubbele sterren (60 seconden)';
  static const String doubleStars60SecondsDesc = 'Verdien dubbele sterren gedurende 60 seconden';
  
  // Theme names
  static const String oledThemeName = 'OLED thema';
  static const String oledThemeDesc = 'Ontgrendel een echt zwart, hoog-contrast thema';
  ...
  static const String errorLoadingSettings = 'Fout bij het laden van instellingen';
  ...
  static const String checkServiceStatus = 'Controleer de status van onze services';
  static const String openStatusPage = 'Open statuspagina';
  
  // Notifications
  static const String motivationNotifications = 'Motivatie-meldingen (Béta)';
  static const String motivationNotificationsDesc = 'Ontvang dagelijkse herinneringen voor BijbelQuiz';
  ...
  static const String userIdDescription = 'Verbind met een ander apparaat met een BQID om je data en statistieken te sychroniseren.';
  static const String pleaseEnterUserId = 'Voer een BQID in';
  static const String failedToConnectToUser = 'Kon niet verbinden met de BQID. Controleer het ID en probeer opnieuw.';
  static const String failedToCreateUserId = 'Kon BQID niet maken. Probeer opnieuw.';
